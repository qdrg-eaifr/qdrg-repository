...
for ((i=0; i<=24; i++)); do
echo $i > fichier
cp ../../Scattering7c/Prop-trial-J015/enerd .
./changetw
cp enerd3 ../Projectors-test-3/RST$i/enerd
done
cd ..
 
cd Test-3-a #Prop-c-J$jtot-n
#mkdir Probability
...
crosscorr84 -n 1 -o Probability/transtotawe-$i/crossfile -f ./psi -r ../Projectors-test-3/RST$i/restart
twprob84 -p 2000 -o Probability/transtotawe-$i/probfile 0.00 300.00 cm-1 Probability/transtotawe-$i/crossfile enerd ../Projectors-test-3/RST$i/enerd
