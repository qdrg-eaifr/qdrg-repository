...
./changetw
cp enerd3 ../Projectors/RST$i/enerd
done
cd ..
...
twprob84 -p 2000 -o Probability/transtotawe-$i/probfile 0.00 300.00 cm-1 Probability/transtotawe-$i/crossfile enerd ../Projectors/RST$i/enerd
