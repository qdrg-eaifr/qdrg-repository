...
###Loop over total J
for jtot in 007; do #009 010 011 012 013 014 015 016 017 018 019 020 021 022 023 024 025 026 027 028 029 030 031 032 033 034 035; do
cd Prop-c-J$jtot
mkdir Probability
...
flux84 -w  -n 1 -o Probability/transtorot-$i -p 2000 -P 2 read ../Projectors-gnrt/RST$i 1 1 % -P 3 read ../Projectors-gnrt/RST$i 1 1 % 0.00 300.00 cm-1 R
