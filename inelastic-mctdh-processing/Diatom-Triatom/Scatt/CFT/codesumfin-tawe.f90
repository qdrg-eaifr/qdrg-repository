...
!
      ...
      real(8)            :: proba1, proba2, vibnrj(16), proba0, Es      
      ...
      real(8), parameter :: E0=37.15834d0/ev2wn, El=1.35785911e-6
!
...
!*!      if (energy1<(E0+El*jtot*(jtot+1))) then
!*!      proba1=0d0
!*!      endif
...
!!!   write(k+0,'(2E20.12)'),energy3,(coeff/energy3)*proba2
      write(k+0,'(2E20.12)'),energy3,(coeff/Es)*proba2
      endif
!!    endif
      enddo
!
