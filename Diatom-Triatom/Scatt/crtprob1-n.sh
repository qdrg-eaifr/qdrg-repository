...
mkdir Probability-n/transtorot-$i
flux84 -w  -n 1 -o Probability-n/transtorot-$i -p 2000 -P 2 read ../Projectors-n/RST$i 1 1 % -P 3 read ../Projectors-n/RST$i 1 1 % 0.00 300.00 cm-1 R
